...
[Self-Signed Certificate](https://wiki.debian.org/Self-Signed_Certificate) and [Update CA Certificates](https://manpages.debian.org/buster/ca-certificates/update-ca-certificates.8.en.html)
