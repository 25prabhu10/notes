...
**_Anthropocene_ (The Age of Humans)**: The Anthropocene Epoch is an unofficial unit of geologic time, used to describe the most recent period in Earth's history when human activity started to have a significant impact on the planet's climate and ecosystems
...
2. [Diet Dr Pepper](https://en.wikipedia.org/wiki/Dr_Pepper):
   ...
   - Pepper sodas (Dr Pepper dose not contain pepper)
   - Artificial drink
   - Need a vice? (desire for self-destruction)
   - 4.5

   | Nutrient Facts (normal) | 355 ml (Candian) |
   | ----------------------- | ---------------- |
   | Calories                | 140              |
   | Sugar                   | 38g              |
   | Sodium                  | 55mg             |
...
1. [Halley's Comet](https://en.wikipedia.org/wiki/Halley%27s_Comet):
   ...
   - 74-79 years
   - Mark Twain
   - Humans forget what we learn
   - 1910 passed through the tail
   - 1986
   - 2061 next visit
   - Measure time in Halley's
   - 5 human life times removed from the building of the Taj Mahal
   - It will return no matter what
   - 5
